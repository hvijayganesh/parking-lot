...
describe("ParkingApp -> park", () => {
  ...
  describe("when a car with same regisration & colour requests to park more than once", () => {
    ...
    it("raise an error when a car with same registration and same color requests to park more than once", () => {
      assert.throws(() => {
...
describe("ParkingApp -> status", () => {
  ...
  describe('leave', function () {
    it('when a car is parked and left', function() {
      const app = new ParkingApp();
      app.createParkingLot(123);
      ...
      assert.equal(app.leave(1), `Slot number 1 is free`);
    });

    it('when a car is parked and trying to leave twice', function() {
      const app = new ParkingApp();
      app.createParkingLot(123);
    ...
    it('When car trying to leave an invalid slot', function() {
      const app = new ParkingApp();
      app.createParkingLot(1);
