const { SlotNotFoundError, ParkingLotFullError, InvalidRequestError, BadDataError } = require('../errors');
...
class ParkingLot {
   ...
   * @return {Slot}
   */
  findNearestEmptySlot(registration = null) {
    ...
    for (let i = 0; i < this.slots.length; i++) {
      ...
      if (registration && slot.registration == registration) {
        throw new BadDataError('Sorry, you cannot ask for newer slot');
      }
